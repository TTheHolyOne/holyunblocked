...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./Options/Classes/PolygonMask", "./PolygonMaskInstance", "../../Utils"], factory);
    }
    ...
    async function loadPolygonMaskPlugin(engine) {
        if (!(0, Utils_1.isSsr)() && !("SVGPathSeg" in window)) {
            await (__syncRequire ? Promise.resolve().then(() => __importStar(require("./pathseg"))) : new Promise((resolve_1, reject_1) => { require(["./pathseg"], resolve_1, reject_1); }).then(__importStar));
        }
